...
export const WORKOUT_DAYS = [
    ...
    { day: 'Thursday', title: 'VO2 Conditioning', time: '40-45 mins', notes: 'Structured VO2 max work kept separate from the Monday, Wednesday, Friday gym split.' },
...
export const EXERCISE_POOL = [
    // MONDAY - UPPER + SOCCER
    { id: 'bench-press', name: 'Bench Press', muscleGroup: 'Chest', secondaryMuscles: [{ muscleGroup: 'Shoulders', multiplier: 0.25 }, { muscleGroup: 'Triceps', multiplier: 0.5 }], defaultSets: 4, reps: '3-6', defaultDay: 'Monday' },
    ...
    { id: 'chest-supported-row', name: 'Chest-Supported Row', muscleGroup: 'Back', secondaryMuscles: [{ muscleGroup: 'Biceps', multiplier: 0.5 }], defaultSets: 4, reps: '8-12', defaultDay: 'Monday' },
    ...
    { id: 'machine-curl', name: 'Machine Curl', muscleGroup: 'Biceps', defaultSets: 4, reps: '10-12', defaultDay: 'Monday' },
    { id: 'overhead-triceps', name: 'Overhead Triceps', muscleGroup: 'Triceps', secondaryMuscles: [{ muscleGroup: 'Shoulders', multiplier: 0.25 }], defaultSets: 4, reps: '10-12', defaultDay: 'Monday' },
    ...
    // THURSDAY - VO2 CONDITIONING
    { id: 'norwegian-4x4', name: 'Norwegian 4x4 Intervals', category: 'Conditioning', fixedSetsLabel: '4 x 4 min @ 90-95% HRmax', reps: '3 min easy recovery between rounds', defaultDay: 'Thursday' },

    // WEDNESDAY - LOWER
    { id: 'back-squat', name: 'Back Squat', muscleGroup: 'Quads', secondaryMuscles: [{ muscleGroup: 'Glutes', multiplier: 0.5 }, { muscleGroup: 'Hamstrings', multiplier: 0.25 }], defaultSets: 4, reps: '3-6', defaultDay: 'Wednesday' },
    { id: 'leg-extension', name: 'Leg Extension', muscleGroup: 'Quads', defaultSets: 4, reps: '10-15', defaultDay: 'Wednesday' },
    { id: 'romanian-deadlift', name: 'Romanian Deadlift', muscleGroup: 'Hamstrings', secondaryMuscles: [{ muscleGroup: 'Glutes', multiplier: 0.5 }], defaultSets: 4, reps: '8-12', defaultDay: 'Wednesday' },
    ...
    { id: 'cable-glute-kickback', name: 'Cable Glute Kickback', muscleGroup: 'Glutes', defaultSets: 4, reps: '12-15', defaultDay: 'Wednesday' },
    ...
    { id: 'cable-fly', name: 'Cable Fly', muscleGroup: 'Chest', defaultSets: 4, reps: '12-15', defaultDay: 'Friday' },
    { id: 'overhead-press', name: 'Overhead Press', muscleGroup: 'Shoulders', secondaryMuscles: [{ muscleGroup: 'Triceps', multiplier: 0.5 }], defaultSets: 4, reps: '6-10', defaultDay: 'Friday' },
    { id: 'full-body-pulldown', name: 'Pulldown', muscleGroup: 'Back', secondaryMuscles: [{ muscleGroup: 'Biceps', multiplier: 0.5 }], defaultSets: 3, reps: '10-12', defaultDay: 'Friday' },
    { id: 'leg-press', name: 'Leg Press', muscleGroup: 'Quads', secondaryMuscles: [{ muscleGroup: 'Glutes', multiplier: 0.5 }], defaultSets: 4, reps: '10-12', defaultDay: 'Friday' },
